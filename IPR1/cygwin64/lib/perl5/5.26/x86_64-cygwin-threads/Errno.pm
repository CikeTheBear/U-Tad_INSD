...
"x86_64-cygwin-threads-multi-3.0.7(0.33853)" or
	die "Errno architecture (x86_64-cygwin-threads-multi-3.0.7(0.33853)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
